				...
				<div class="col-lg-10">
					<div class="d-flex justify-content-start">
						<ul class="nav">
							  ...
							  <li class="nav-item">
							     <a class="nav-link font-weight-bold border-left" href="<?php echo site_url('lapor/data_bencana') ?>" style="color: black; font-size: 1.3vw;">Data Laporan Bencana</a>
							  </li>
							  <li class="nav-item">
							     <a class="nav-link font-weight-bold border-left" href="<?php echo site_url('lapor/data_pengungsi') ?>" style="color: black; font-size: 1.3vw;">Data Laporan Pengungsi</a>
							  </li>
